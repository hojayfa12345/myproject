    ...
    <div class="wrapper light-wrapper">
      <div class="container inner">
        ...
        <div class="row text-center">
          <div class="col-md-4">
            <figure class="img-blob blob1 mb-25"><img src="{{ asset('public/frontend/style/images/art/te1.jpg')}}" style="width: 15rem" alt="" /></figure>
          ...
          <!--/column -->
          <div class="col-md-4">
            <figure class="img-blob blob1 mb-25"><img src="{{ asset('public/frontend/style/images/art/te2.jpg')}}" style="width: 15rem" alt="" /></figure>
          ...
          <!--/column -->
          <div class="col-md-4">
            <figure class="img-blob blob1 mb-25"><img src="{{ asset('public/frontend/style/images/art/te3.jpg')}}" style="width: 15rem" alt="" /></figure>
      ...
      <div class="container inner">
        ...
        <div class="grid-view">
          <div class="carousel owl-carousel text-center" data-margin="30" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "3"}}'>
            ...
            <!-- /.item -->
            <div class="item">
              <figure class="img-blob blob1 mb-25"><img src="{{ asset('public/frontend/style/images/art/te4.jpg')}}" style="width: 15rem" alt="" /></figure>
            ...
            <!-- /.item -->
            <div class="item">
              <figure class="img-blob blob1 mb-25"><img src="{{ asset('public/frontend/style/images/art/te5.jpg')}}" style="width: 15rem" alt="" /></figure>
